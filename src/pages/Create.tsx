...
export default function () {
    ...
    async function Authorize() {
        ...
        const response = await fetch("/authorize", {
            ...
            body: JSON.stringify({ username, password, type: 'new' })
        });
    ...
    return (
        <div className="m-50 text-center place-items-center">
            <div className="text-9xl">Create</div>
            <p className="my-4 text-xl">Are you a user? If yes login <a className="text-blue-300" href="/here">here</a></p>
            <div className="w-100">
